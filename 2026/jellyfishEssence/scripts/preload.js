...
class Load extends Phaser.Scene {
	...
	preload() {
		...
		this.load.image('essencetxt', 'img/essencetxt.png');
		...
		this.load.image('btn_start', 'img/btn_start' + window.language + '.png');
		this.load.image('game_title', 'img/game_title.png');
		/* this.load.image('popup_paused','img/popup_paused.png'); */
		this.load.image('btncta', 'img/btn_cta' + window.language + '.png');
