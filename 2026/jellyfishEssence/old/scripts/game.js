...
class Game extends Phaser.Scene {
  ...
  update() {
    if (this.ready) {
      ...
      // Update shadow positions to follow players
      if (this.shadow_player1) {
        this.shadow_player1.setPosition(this.player1.x - this.player1.displayWidth * .06, this.player1.y + this.player1.displayHeight / 4);
      }
  ...
  create() {
    ...
    // Create shadow for player 1 (bottom player)
    this.shadow_player1 = this.add.graphics();
    this.shadow_player1.fillStyle(0x000000, 0.3); // Semi-transparent black
    this.shadow_player1.fillEllipse(0, 0, 60, 20); // Ellipse shadow
    this.shadow_player1.setPosition(config.width / 2, 880);
    this.shadow_player1.setDepth(0); // Behind player
    ...
    // Create shadow for player 2 (top player/AI)
    this.shadow_player2 = this.add.graphics();
    this.shadow_player2.fillStyle(0x000000, 0.3); // Semi-transparent black
    this.shadow_player2.fillEllipse(0, 0, 60, 20); // Ellipse shadow
    this.shadow_player2.setPosition(config.width / 2, 320);
    this.shadow_player2.setDepth(0); // Behind player
    ...
    function ballHit1(ball, player1) {
      ...
      self.cameras.main.shake(50, 0.005);
