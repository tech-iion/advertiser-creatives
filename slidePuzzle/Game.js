...
export default class Game extends Phaser.Scene {
  ...
  create() {
    ...
    this.boxInside = this.add
      .image(this.canvasWidth / 2, this.canvasHeight / 2, "box-inside")
      .setScale(0.6)
      .setOrigin(0.5);
  ...
  startPuzzle(key, rows, columns) {
    ...
    const photoWidth = texture.width * 0.968;
    const photoHeight = texture.height * 0.968;
    ...
    if (this.pieces) {
      ...
      this.pieces = this.add.container(
        this.boxInside.x - this.boxInside.displayWidth / 2,
        this.boxInside.y - this.boxInside.displayHeight / 2
      );
    }
